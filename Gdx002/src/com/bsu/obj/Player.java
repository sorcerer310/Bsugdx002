...
public class Player {
	...
	private Array<Role> getPlayerRole() {
		if (playerRole.size == 0) {
			...
			playerRole.add(rf.getCleric("努努", Type.HERO, QUALITY.green,GameTextureClass.getInstance().fc_photo));
			playerRole.add(rf.getSorcerer("努努", Type.HERO, QUALITY.green,GameTextureClass.getInstance().fc_photo));
			playerRole.add(rf.getWizard("努努", Type.HERO, QUALITY.green,GameTextureClass.getInstance().fc_photo));
			...
			playerRole.add(rf.getFighter("努努", Type.HERO, QUALITY.orange,GameTextureClass.getInstance().fc_photo));
